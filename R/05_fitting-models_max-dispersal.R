...
gtsave(table_main, path = "figures/model_results", filename = "table_main-models_all-observations.png")
...
ggsave(path = "figures/model_results", filename = "main-model-predictions_all-observations.png", 
       width = 12.5, height = 4)
...
gtsave(table_di, path = "figures/model_results", filename = "table_main-models_di-observations.png")
...
ggsave(path = "figures/model_results", filename = "main-model-predictions_di-observations.png", 
       width = 8.5, height = 4)
...
ggsave(path = "figures/model_results", filename = "main-model-predictions_ds-observations.png", 
       width = 8.5, height = 4)
